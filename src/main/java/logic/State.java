...
//    }
    ...
    public State applyMove(Move move) {
        // added if there is one king left
        //if (gameOver==0) {
...
//        }
            ...
            if (applyCastling) {
                //System.out.println("apply castling1");

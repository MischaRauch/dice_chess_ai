...
public class Board implements BoardInterface {
    ...
    public static void main(String[] args) {
        ...
        BoardInterface b = new Board(openingFEN);
        Board afterVariousMoves = (Board) b.movePiece("e2", "e4")
                .movePiece("b8", "c6")
                .movePiece("b2", "b4")
                .movePiece("c6", "b4");
    ...
    @Override
    public BoardInterface movePiece(String origin, String destination) {
    ...
    @Override
    public BoardInterface loadFromFEN(String FEN) {
